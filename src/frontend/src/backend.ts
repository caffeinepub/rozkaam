...
import type { Labour as _Labour, User as _User, UserProfile as _UserProfile, UserRole as _UserRole, UserRole__1 as _UserRole__1, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getLaboursBySkillAndArea(arg0: string, arg1: string): Promise<Array<Labour>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLaboursBySkillAndArea(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyLabourProfile(): Promise<Labour | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyLabourProfile();
    ...
    async getUserInfo(arg0: Principal): Promise<User | null> {
        if (this.processError) {
            try {
    ...
    async registerUser(arg0: UserRole): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.registerUser(to_candid_UserRole_n22(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setLabourAvailability(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setLabourAvailability(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateLabourProfile(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateLabourProfile(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Labour]): Labour | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.name)),
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "customer" in value ? UserRole.customer : "labour" in value ? UserRole.labour : value;
}
